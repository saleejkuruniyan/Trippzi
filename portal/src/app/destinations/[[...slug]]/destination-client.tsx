            ...
            >
              ...
              <ul className="space-y-3">
                {(Array.isArray(dest.airports) 
                  ? dest.airports 
                  : (typeof dest.airports === 'string' ? dest.airports.split(',').map((a: string) => a.trim()).filter(Boolean) : [])
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {(Array.isArray(dest.tips) 
                    ? dest.tips 
                    : (typeof dest.tips === 'string' ? dest.tips.split(',').map((t: string) => t.trim()).filter(Boolean) : [])
