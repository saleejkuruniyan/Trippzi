...
import { ShieldCheck, CreditCard, Download } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-[var(--background)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                <motion.div 
                  ...
                  className="p-8 rounded-[2rem] bg-[var(--background)] border border-zinc-100 dark:border-zinc-800 hover:shadow-xl transition-all"
                >
